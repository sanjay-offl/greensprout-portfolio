...
const mentors = [
  {
    ...
    area: 'Agri-Engineering · Research Methodology',
  },
  {
    name: 'Mr. Sakthi Navaneethan B',
    role: 'Industry Mentor',
    initials: 'SN',
    description: 'Supporting go-to-market strategy, supply chain optimization, business model development, and regulatory compliance for the agri-tech sector.',
    area: 'Business Strategy · Market Expansion',
  },
];
    ...
    <main className="py-32 px-6 max-w-7xl mx-auto min-h-screen">
      <div className="text-center mb-16">
        ...
        <p className="text-light text-lg max-w-2xl mx-auto">
          Expert guidance from academia and industry shaping GREENSPROUT's strategy and technology direction.
        </p>
      </div>
          ...
          <div key={mentor.name} className="card-base hover:border-accent/40 group p-10">
            <div className="flex items-center gap-5 mb-6">
              ...
              <div>
                ...
                <p className="text-accent font-semibold text-sm uppercase tracking-wider mt-1">{mentor.role}</p>
              </div>
            </div>
            <p className="text-dark/70 leading-relaxed mb-5">{mentor.description}</p>
            <div className="bg-primary/5 rounded-xl px-4 py-3 text-xs text-primary font-semibold">
              Area of Expertise: {mentor.area}
            </div>
          </div>
        ))}
      </div>
